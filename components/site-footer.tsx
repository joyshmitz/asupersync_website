              ...
              <div className="space-y-4">
                <Link href="/" className="flex items-center gap-3 group w-fit">
                  <GlitchText trigger="hover" intensity="low">
                    <div className="h-8 w-8 rounded-lg bg-blue-500 flex items-center justify-center font-black text-white text-xs transition-transform group-hover:scale-110">A</div>
                  </GlitchText>
